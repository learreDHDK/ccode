...
def final(dict):
    ...
    hurricanesdict2 = exceptions(hurricanesdict, {'China': ['China 中国'], 'Spain': ['España'], 'Mozambique': ['Moçambique'], 'Mexico': ['México'], 'Dominican Republic': ['República Dominicana'], 'Samoa': ['Sāmoa'], 'Vietnam': ['Việt Nam'], 'India': ['भारत - India'], 'Japan': ['日本 (Japan)']})
